...
import org.osgpfoundation.osgp.cucumber.platform.distributionautomation.support.ws.distributionautomation.monitoring.GetPqValuesRequestBuilder;
...
public class GetPqValuesSteps extends GlueBase {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetPqValuesSteps.class);

    @Autowired
    private MonitoringClient client;

    @When("^I send a getPQValues request$")
    public void iSendGetPQValuesRequest(final Map<String, String> requestParameters) throws Throwable {

        final GetPQValuesRequest getPQValuesRequest = GetPqValuesRequestBuilder.fromParameterMap(requestParameters);
        final GetPQValuesAsyncResponse response = this.client.getPQValuesAsyncResponse(getPQValuesRequest);
    ...
    public void iShouldRecieveResponseForGetPQValuesResponseRequest(final Map<String, String> responseParameters) throws Throwable {
        ...
        final GetPQValuesAsyncRequest getPQValuesAsyncRequest = GetPqValuesRequestBuilder.fromParameterMapAsync(extendedParameters);
        final GetPQValuesResponse response = this.client.getPQValuesResponse(getPQValuesAsyncRequest);
