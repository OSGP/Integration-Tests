 ...
 */
public class AuthorizeDeviceFunctionsPublicLightingSteps {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AuthorizeDeviceFunctionsPublicLightingSteps.class);
